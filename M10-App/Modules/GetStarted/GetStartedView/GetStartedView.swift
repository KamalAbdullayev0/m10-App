...
class GetStartedView: UIViewController {
    ...
    private let logoView = SVGImageLoader.loadSVG(named: "logo10lar", width: 400, height: 450)
    ...
    private let bottomLabel: UILabel = {
        ...
        paragraphStyle.lineSpacing = 5 // Тут задаем межстрочный интервал
    ...
    private func setupUI() {
        ...
        NSLayoutConstraint.activate([
            ...
            // Векторное изображение на всю ширину
